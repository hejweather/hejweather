  ...
  const search = async (evt) => {
    if (evt.key === "Enter") {
      try {
        ...
        const prompt = ` starta meningen med "kuk" Give me a two-sentence recommendation on what to wear and something fun to do if the weather is ${roundedTemp}°C and ${weatherData.weather[0].description}. keep it positive! end with "!!!!!"=)`;
