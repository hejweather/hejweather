  ...
  const search = async (evt) => {
    if (evt.key === "Enter") {
      try {
        ...
        const prompt = `Give me a two-sentence recommendation on what to wear and something fun to do if the weather is ${roundedTemp}°C and ${weatherData.weather[0].description}. keep it positive!=)(use only whole degrees if you mention it, round up or down)`;
