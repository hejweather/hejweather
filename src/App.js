  ...
  const search = async (evt) => {
    if (evt.key === "Enter") {
      try {
        ...
        const prompt = ` svara som christer pettersson, max 2 meningar, vad kan man göra när det är ${roundedTemp}°C and ${weatherData.weather[0].description}. svär gärna tack =) `;
